...
.. |commits-since| image:: https://img.shields.io/github/commits-since/Tuck-Williamson/python-agh/v0.2.1.svg
    :alt: Commits since latest release
    :target: https://github.com/Tuck-Williamson/python-agh/compare/v0.2.1...main
